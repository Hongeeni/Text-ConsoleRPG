...
protected:
    ...
    std::unordered_map<std::string, int> player_life = { {"current_life", 3}, {"max_life", 3} };
...
public:
    ...
    void SetPlayerLife(int new_current_life, int new_max_exp);
    ...
    const std::unordered_map<std::string, int> GetPlayerLife(void);
