...
Item::Item(string category, 
    ...
    int bonusHp, int bonusMp, int bonusAtk, int bonusDef, 
    int bonusCrit, int bonusSpd)
    ...
    m_bonusAtk(bonusAtk), m_bonusDef(bonusDef), 
    m_bonusCrit(bonusCrit), m_bonusSpd(bonusSpd)
{
}
